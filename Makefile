...
.PHONY: build-x86_64
build-x86_64: $(kernel_object_files) $(x86_64_object_files) build/x86_64/print.o
	mkdir -p dist/x86_64 && \
	g++ $(LDFLAGS) -nostdlib -nostartfiles -o dist/x86_64/kernel.bin $(kernel_object_files) $(x86_64_object_files) build/x86_64/print.o && \
